...
from nerfstudio.models.vqad import VQADModelConfig
...
descriptions = {
    "vqad" :  "Variable Bitrate Neural Fields",
...
method_configs["vqad"] = Config(
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=VQADModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
